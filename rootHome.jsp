...
<body style="background-color:rgb(195, 222, 198)">
    ...
    <div class="container-fluid" style="margin-top: 80px;">
        <row class="row justify-content-center">
            ...
            <h1 class="text-center" style="color: rgb(175, 40, 90)">Welcome to the Spring 2022 Project 4 Enterprise Database System </h1>
            ...
            <div class="text-center col-sm-12 col-md-12 col-lg-12"> You are connected to the Project 4 Enterprise System database as a <span style="color: red;">root-level</span> user.</div>
            ...
            <form action = "/Project4/RootUserAppServlet" method = "post" style="margin-top: 15px;" class="text-center">
